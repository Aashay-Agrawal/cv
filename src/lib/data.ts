...
const defaultData: PortfolioData = {
  about: {
    name: "Aashay Agrawal",
    text: `Hey, I'm Aashay. I'm a Designer. While I design for a living, I don't really like to label myself as a designer. I'm neither worthy enough to have that title, nor desire enough to earn it. The best way to define me is this — I'm just someone you can rent to solve your problems. Basically, my time.
